...
public class Database extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        if (oldVersion < 2) {
            ...
            String qry3 = "CREATE TABLE IF NOT EXISTS orderplace(username TEXT, fullname TEXT, address TEXT, contactno TEXT, pincode INT, date TEXT, time TEXT, amount FLOAT, otype TEXT)";
            sqLiteDatabase.execSQL(qry3);
        }
    }
